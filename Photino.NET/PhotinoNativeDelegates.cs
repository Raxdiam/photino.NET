...
namespace PhotinoNET
{
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Auto)] public delegate void CppFileDragDropDelegate(string id, IntPtr files, int numFiles);
